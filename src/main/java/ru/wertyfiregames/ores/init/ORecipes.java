...
public class ORecipes {
    public static void register() {
        ...
        GameRegistry.addSmelting(OBlocks.tin_ore, new ItemStack(OItems.tin_ingot), 0.7f);
        ...
        GameRegistry.addRecipe(new ItemStack(OBlocks.tin_block), "SSS", "SSS", "SSS", 'S', OItems.tin_ingot);
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(OItems.tin_ingot, 9), new ItemStack(OBlocks.tin_block));
    }
}